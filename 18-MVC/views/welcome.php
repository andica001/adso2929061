                ...
                <?php foreach ($data as $pokemon): ?>
                    <tr>
                        ...
                        <td class="border text-center">
                            ...
                            <a href="javascript:" data-id="<?= $pokemon['id'] ?>" data-name="<?= $pokemon['name'] ?>" class="btn btn-del"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#000000" viewBox="0 0 256 256">
